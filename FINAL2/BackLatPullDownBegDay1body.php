...
<body>
  <h1 align="center">Back exercise: Lat Pull Down</h1>
  <hr>
  <div class="container">
  <div>
    <button class="animated-button-2" onclick="clic()">Start time</button>
    <br><img src="img/backpulldown.jpg" class="main">
  <br>

  <img src="img/n.jpg" style="width:70;padding:0px 100px 0px 100px;border-radius:50%"></a>

  <a href="SeatedDumbBellPressBegDay1.php"><img src="img/p.png" style="width:70;padding:0px 100px 0px 100px;border-radius:50%"></a>
